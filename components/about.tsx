            ...
            <div className="md:w-2/3">
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                <div className="flex items-center">
                  <div className="w-10 h-10 rounded-full bg-blue-900/50 flex items-center justify-center mr-3 overflow-hidden">
                    <Image src="/srmist_logo.png" alt="SRMIST" width={28} height={28} />
                  </div>
                ...
                <div className="flex items-center">
                  <div className="w-10 h-10 rounded-full bg-blue-900/50 flex items-center justify-center mr-3 overflow-hidden">
                    <Image src="/samsung_prism.png" alt="Samsung" width={28} height={28} />
                  </div>
